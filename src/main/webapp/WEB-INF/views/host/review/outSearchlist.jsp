	...
	$("document").ready(function(){
		...
		$("tr[id^=index_]").click(function(){
			...
			$("tr[id^=index_]").css("background","");
		     ...
		     var title = thisTd.find("input[name^=h_url]").val();
	...
	<table>
		...
		<tr id="index_${i.index}">
			<td style="display: none;">
				...
				<input type="text" name="h_url${i.index}" value="${list_title.get(i.index)}">
				<input type="text" name="h_title${i.index}" value="${url}">
			</td>
