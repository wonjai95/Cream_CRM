...
<body>
	<div class="ibox-content">
		...
		<form action="slip_modifyAction" method="post" id="slip_modifyForm">
			<sec:csrfInput/>
			<input type="hidden" value="${dto.slip_code}" name="slip_code">
			<div class="form-group  row">
				<label class="col-sm-2 col-form-label">날짜</label>
				<div class="col-sm-7">
					<input type="date" class="form-control" name="slip_regDate" 
			...
			<div class="form-group  row">
				...
				<div class="col-sm-7">
					<select class="form-control-sm form-control input-s-sm inline" name="slip_type" id="slip_type" style="width:60%; ">
			...
			<div class="form-group  row">
				...
				<div class="col-sm-3">
					<input type="text" class="form-control" name="slip_money" 
			...
			<div class="form-group  row">
				...
				<div class="col-sm-3">
					<input type="text" class="form-control" name="slip_memo" 
